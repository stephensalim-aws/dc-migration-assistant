...
@Component
@Primary
public class EncryptedCredentialsManager implements ReadCredentialsService,WriteCredentialsService,CredentialsManager {

    private final static Logger LOGGER = Logger.getLogger(EncryptedCredentialsManager.class);
    ...
    @Autowired
    public EncryptedCredentialsManager(@ComponentImport PluginSettingsFactory pluginSettingsFactory, @ComponentImport JiraLicenseService jiraLicenseService) {
